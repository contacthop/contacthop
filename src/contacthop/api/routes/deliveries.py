...
from contacthop.api.deps import PrincipalDep, SessionDep, SettingsDep, ensure_visible
...
async def list_deliveries(
    ...
    if principal.agent is not None:
        query = query.where(AgentDelivery.agent_id == principal.agent.id)
...
async def retry_delivery(
    ...
    ensure_visible(delivery.agent_id, principal)
